...
- В WebApp выберите группы (из уже сохранённых в БД) и добавьте ключевые слова.
- Бот будет отслеживать сообщения в группах, которые вы выбрали, и слать уведомления при совпадении по ключевым словам (пользователю или в фиксированный чат, в зависимости от настроек).
